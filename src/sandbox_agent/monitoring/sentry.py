...
from sandbox_agent.aio_settings import aiosettings, goob_user_agent
...
def sentry_init(**sentry_init_kwargs):
    ...
    set_tag("sandbox_agent.build_hash", "")
    set_tag("sandbox_agent.env", "dev")
    set_tag("sandbox_agent.component", "backend")
