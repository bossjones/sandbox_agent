...
def split_and_cluster_strings(
    input_string: str, max_cluster_size: int, split_substring: Union[str, Pattern], length: Callable[[str], int] = len
) -> list[str]:
    """
...
def seconds_to_time_string(seconds_start: Union[int, float]) -> str:
    """
...
async def get_server_icon_color(guild: discord.Guild) -> Union[str, int]:
    """
