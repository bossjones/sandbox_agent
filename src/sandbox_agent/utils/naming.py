...
from sandbox_agent.utils.misc import formatdoc
...
def magic_name(value, *, path_prefix):
    ...
    try:
        ...
        # https://github.com/sandbox_agent/sandbox_agent/pull/1635
        if inspect.isframe(frame):
            frame = frame.f_back

        # Iterate frames while filename starts with path_prefix (part of sandbox_agent)
