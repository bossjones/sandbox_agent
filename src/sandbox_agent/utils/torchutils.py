...
from sandbox_agent.gen_ai.arch.ScreenCropNet import (
...
def load_model(device: torch.device, model_name: str = "ScreenNetV1.pth"):
    ...
    model.to(device)
    # NOTE: Temporary
    my_custom_ml_models_path = (
        "/Users/malcolm/dev/bossjones/sandbox_agent/src/sandbox_agent/data/"
    )
