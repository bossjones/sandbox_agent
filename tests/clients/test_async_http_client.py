...
from sandbox_agent.clients.http_client import AsyncHttpxClient
...
@pytest.mark.httpclientonly()
@pytest.mark.asyncio()
async def test_post_bad_http_code(
    respx_mock: respx.MockRouter, caplog: LogCaptureFixture
):
    """
...
@pytest.mark.httpclientonly()
@pytest.mark.asyncio()
async def test_get_bad_http_code(
    respx_mock: respx.MockRouter, caplog: LogCaptureFixture
):
    """
