...
#     mock_download = mocker.patch("sandbox_agent.utils.file_operations.download_image", side_effect=Exception("Download failed"))
...
#     mock_process_attachments = mocker.patch.object(sandbox_agent, "process_attachments", side_effect=Exception("Processing failed"))
