...
def accuracy(reference, test): # -> float:
    """
...
def precision(reference, test): # -> float | None:
    """
...
def recall(reference, test): # -> float | None:
    """
    Given a set of reference values and a set of test values, return
...
def f_measure(reference, test, alpha=...): # -> float | Literal[0] | None:
    """
    Given a set of reference values and a set of test values, return
...
def log_likelihood(reference, test): # -> float:
    """
    Given a list of reference values and a corresponding list of test
...
def approxrand(a, b, **kwargs): # -> tuple[Any, float, Any]:
    """
