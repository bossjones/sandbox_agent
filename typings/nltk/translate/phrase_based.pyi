...
def extract(f_start, f_end, e_start, e_end, alignment, f_aligned, srctext, trgtext, srclen, trglen, max_phrase_length): # -> dict | set:
    """
...
def phrase_extraction(srctext, trgtext, alignment, max_phrase_length=...): # -> set:
    """
