...
"""
def chomsky_normal_form(tree, factor=..., horzMarkov=..., vertMarkov=..., childChar=..., parentChar=...): # -> None:
    ...

def un_chomsky_normal_form(tree, expandUnary=..., childChar=..., parentChar=..., unaryChar=...): # -> None:
    ...

def collapse_unary(tree, collapsePOS=..., collapseRoot=..., joinChar=...): # -> None:
    """
